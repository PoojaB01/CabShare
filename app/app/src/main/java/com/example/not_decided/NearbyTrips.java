...
public class NearbyTrips extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, Message_reply.Message_replyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time = (TextView) findViewById(R.id.button_time);
        date = (TextView) findViewById(R.id.button_date);
            ...
            public void onBtnClick(int position) {
                ...
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dialog = new Message_reply(trip.getUID(), new Message(UID, trip.getUID(), "", "", name, trip.getName()));
